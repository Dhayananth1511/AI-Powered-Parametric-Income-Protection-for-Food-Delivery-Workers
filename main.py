...
if __name__ == "__main__":
    ...
    print("")
    print("Official Demo Credentials:")
    print("Worker 1: ravi.kumar@swiggy.in / demo1234")
    print("Worker 2: meena.s@zomato.in   / demo1234")
    print("Admin 1 : admin@digit.com     / admin123")
    print("Admin 2 : ops@gigpulse.in     / admin123")
